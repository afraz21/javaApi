...
@Controller
public class TwitterControllerCarib {

	@Autowired
	@Qualifier("twitterServiceProviderCarib")
	private OAuthServiceProviderCarib twitterServiceProviderCarib;

	@RequestMapping(value = { "/login-twitter-caribtix" }, method = RequestMethod.GET)
	public String login(WebRequest request) {
		...
		OAuthService service = twitterServiceProviderCarib.getTwitterService();
	...
	@ResponseBody
	@RequestMapping(value = { "/twitter-callback-caribtix" }, method = RequestMethod.GET)
	public String callback(@RequestParam(value = "oauth_token", required = false) String oauthToken, @RequestParam(value = "oauth_verifier", required = false) String oauthVerifier, WebRequest request) {
...
/*	public void uploadImageAndText(Token accessToken, String text, String imageFileUrl) {
	...
	public void uploadImageAndText(Token accesstoken, String text, String imageFileUrl) {
		...
		String consumerKey =twitterServiceProviderCarib.getConfig().getApiKey();

		// Your Twitter App's Consumer Secret
		String consumerSecret = twitterServiceProviderCarib.getConfig().getApiSecret();
